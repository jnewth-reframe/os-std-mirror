...
import(path : "onshape/std/cutlistMath.fs", version : "3008.0");
import(path : "onshape/std/deleteBodies.fs", version : "3008.0");
import(path : "onshape/std/error.fs", version : "3008.0");
import(path : "onshape/std/feature.fs", version : "3008.0");
import(path : "onshape/std/frameAttributes.fs", version : "3008.0");
import(path : "onshape/std/frameUtils.fs", version : "3008.0");
