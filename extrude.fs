...
export import(path : "onshape/std/flatOperationType.fs", version : "3008.0");
...
import(path : "onshape/std/drafttype.gen.fs", version : "3008.0");
...
import(path : "onshape/std/sheetMetalInFlat.fs", version : "3008.0");
