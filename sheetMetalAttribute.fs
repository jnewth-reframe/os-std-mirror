...
export import(path : "onshape/std/smbendtype.gen.fs", version : "3008.0");
export import(path : "onshape/std/smcornerbreakstyle.gen.fs", version : "3008.0");
...
export import(path : "onshape/std/smobjecttype.gen.fs", version : "3008.0");
export import(path : "onshape/std/smreliefstyle.gen.fs", version : "3008.0");
